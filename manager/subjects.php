            ...
            <h3>
              ...
              {this.state.data_courses.length > 0 ?
                ...
                <div className="col-md-4 mt-5">
                  <input name="course_id" required value={this.state.input_course_select} readonly required type="text" className="form-control" placeholder="course_id"/>
                </div>
                <div className="col-md-4 mt-5">
                ...
                <div className="col-md-4 mt-5">
                  <input type="text" className="form-control" name="code" required value={this.state.auto_subject} readonly placeholder="Subject-code(Auto)"/>
                </div>
                </div>
                <div className="row">
                <div className="col-md-4 mt-5">
                  <input type="text" className="form-control" required name="name" onChange={this.onChangeHandler_auto_code.bind(this)} placeholder="Name"/>
                </div>
